...
const messages = {
  ...
  alpha_dash: (field) => `${field}-feltet kan bare inneholde alfanumeriske tegn, samt bindestrek og understrek`,
  alpha_num: (field) => `${field} kan bare inneholde alfanumeriske tegn`,
  alpha_spaces: (field) => `${field}-feltet kan bare inneholde alfanumeriske tegn og mellomrom`,
  ...
  excluded: (field) => `${field}-feltet må være en gyldig verdi`,
