...
const messages = {
  ...
  decimal: (field, [decimals = '*'] = []) => `El camp ${field} ha de ser numèric i contenir${!decimals || decimals === '*' ? '' : ' ' + decimals} punts decimals`,
  ...
  excluded: (field) => `El camp ${field} ha de ser un valor vàlid`,
  ext: (field) => `El camp ${field} ha de ser un fitxer vàlid`,
  image: (field) => `El camp ${field} ha de ser una imatge`,
  included: (field) => `El camp ${field} ha de ser un valor vàlid`,
